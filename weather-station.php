    ...
    <table style="border:none">
        <tr>
            ...
            <td style = "border:none">
                <form action="">
                    <label>Mittausjakso: </label>              
                    <input id="intervalSet" name="name" type="number" min = "1" max = "86400" placeholder="60" class="required"/>    
                    <button type="button" class="button" onclick="setMeasPeriod();">Aseta</button>
                </form>
            </td>
        </tr>
    </table>
    ...
    <script type="text/javascript">
        ...
        function toggleMeasurement() {
            ...
            if (x.innerHTML === "Pysäytä mittaus") {
                x.innerHTML = "Aloita mittaus";
                x.style.cssText ="color: green; font-weight: bold";
                document.getElementById("measurementStatus").innerHTML = "(pysäytetty)";
                url += "0";
                

            } else {
                x.innerHTML = "Pysäytä mittaus";
                x.style.cssText ="color: black; font-weight: normal";
        ...
        function deleteTable() {
	        if (confirm("Haluatko varmasti poistaa kaikki mittaukset")) {
